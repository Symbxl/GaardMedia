...
const categories = ["All", "Video Production", "Social Media", "Branding", "Drone / Aerial", "Podcasting"];
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <FadeIn className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg text-gray-500 leading-relaxed">
              Expert tips on video production, social media strategy, branding, and digital marketing to help your business grow.
            </p>
          </FadeIn>
        </div>
      </section>
              ...
              <StaggerItem key={post.slug}>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    {/* Title */}
                    <h2 className="mt-3 font-display text-lg font-bold text-gray-900 group-hover:text-red-600 transition-colors duration-300 line-clamp-2">
                      {post.title}
                    </h2>
